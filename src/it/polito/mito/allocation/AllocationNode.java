...
public class AllocationNode {
	...
	List<Predicate> forwardBehaviourPredicateList2 = new ArrayList<>();
	List<Integer> forwardBehaviourList2 = new ArrayList<>();
	List<Integer> droppedList2 = new ArrayList<>();
	...
	public void addForwardingPredicate2(int ap) {
		forwardBehaviourList2.add(ap);
	}
	
	public void addDroppedPredicate2(int ap) {
		droppedList2.add(ap);
	}
	...
	public List<Predicate> getForwardBehaviourPredicateList2() {
		return forwardBehaviourPredicateList2;
	}

	public void setForwardBehaviourPredicateList2(List<Predicate> forwardBehaviourPredicateList2) {
		this.forwardBehaviourPredicateList2 = forwardBehaviourPredicateList2;
	}

	public List<Integer> getForwardBehaviourList2() {
		return forwardBehaviourList2;
	}

	public void setForwardBehaviourList2(List<Integer> forwardBehaviourList2) {
		this.forwardBehaviourList2 = forwardBehaviourList2;
	}

	public List<Integer> getDroppedList2() {
		return droppedList2;
	}

	public void setDroppedList2(List<Integer> droppedList2) {
