...
import it.polito.mito.jaxb.AllocationConstraintType;
import it.polito.mito.jaxb.AllocationConstraints;
import it.polito.mito.jaxb.Configuration;
import it.polito.mito.jaxb.Firewall;
import it.polito.mito.jaxb.FunctionalTypes;
import it.polito.mito.jaxb.Graph;
import it.polito.mito.jaxb.NFV;
import it.polito.mito.jaxb.Neighbour;
import it.polito.mito.jaxb.Node;
import it.polito.mito.jaxb.AllocationConstraints.AllocationConstraint;
				...
				if(!neighbour.getName().startsWith(initialAPIp)) {
					...
					if(notForbidden) {
						...
						if(fwForced) {
							...
							allocationPlace.getConfiguration().add(confFW);
						}
