package it.polito.mito.test.rest;
...
public class TestRestSimulation {
	...
	final String target = "http://127.0.0.1:8085/mito/adp/simulations";
	...
	public void testRunSimulationByParams() {
		...
		Response respGraph = ClientBuilder.newClient()
					.target("http://127.0.0.1:8085/mito/adp/graphs")
					.request(MediaType.APPLICATION_XML)
					.accept(MediaType.APPLICATION_XML)
		...
		Response respReq = ClientBuilder.newClient()
					.target("http://127.0.0.1:8085/mito/adp/requirements")
					.request(MediaType.APPLICATION_XML)
					.accept(MediaType.APPLICATION_XML)
